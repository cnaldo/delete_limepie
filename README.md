...
사용자가 접근한 URI를 '/'로 구분해 의미를 부여하고, 연관 프로그램을 호출하는 방식으로 동작 하며 MVC (Model-View-Controller) 디자인 패턴을 채택해 클라이언트 프로그램에서 보여지는 부분과 작동되는 기능들을 분리할수 있습니다.
...
몇개의 간단한 기호를 사용함으로 개발자의 반복작업을 줄이거나 디자이너가 템플릿 파일을 효율적으로 다룰수도 있습니다. 
