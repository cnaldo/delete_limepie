<script src="<?php echo BASE_PATH;?>vendor/js/source/jquery/jquery-1.9.1.min.js"></script>
	...
	try {
		...
		_submit({
			...
			success : function(ret) {
				alert(_t('저장되었습니다.'));
				document.location.href = client.path + '<?php $module["module_name"];?>/list/<?php $selected_category_seq;?>';
			}
		});
	} catch (e) {
		consolelog(e);
